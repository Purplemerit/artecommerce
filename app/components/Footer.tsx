            ...
            <div className="max-w-[1400px] mx-auto px-6">
                <div className="flex flex-col lg:flex-row justify-between items-start mb-20">
                    ...
                    <div className="flex flex-col items-start gap-6 max-w-xs">
                        ...
                        <form action="/api/newsletter" method="POST" className="w-full flex">
                            <input
                                type="email"
                                name="email"
                    ...
                    <div className="flex gap-20 mt-12 lg:mt-0 lg:mr-32">
                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            <ul className="flex flex-col gap-3 font-sans text-[16px] text-[#555]">
                                <li><Link href="/" className="hover:text-black hover:underline underline-offset-4 transition-all">Home</Link></li>
                                <li><Link href="/shop" className="hover:text-black hover:underline underline-offset-4 transition-all">Shop</Link></li>
                                <li><Link href="/about" className="hover:text-black hover:underline underline-offset-4 transition-all">About</Link></li>
                                <li><Link href="/terms" className="hover:text-black hover:underline underline-offset-4 transition-all">Terms</Link></li>
                                <li><Link href="/privacy" className="hover:text-black hover:underline underline-offset-4 transition-all">Privacy Policy</Link></li>
                                <li><Link href="/faq" className="hover:text-black hover:underline underline-offset-4 transition-all">FAQs</Link></li>
                            </ul>
                        </div>
